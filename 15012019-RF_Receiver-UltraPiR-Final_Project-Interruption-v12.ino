...
//Entra em modo de recepcao
  ...
  TIMSK1 = 3;                        // ativa o Timer/Counter1 com os modos dos bits 0 e 1, ou seja,// ativa Comparador A e detector de overflow

  TCCR1A = 0;                        // desabilita inicialmente o timer
  TCCR1B = 0;                        // desabilita inicialmente o timer
 
 }
 
void zeroCross() {
TCCR1B=4;                            // habilita o timer no modo que divide o clock real por 256
...
if (digitalRead(pinPiR) == HIGH)  //Se Alguém passar na frente do carro o mesmo para através da sensibilidade do sensor PiR
    {
    TCNT1 = 49911;               // inicia timer com valor para que estouro ocorra em 1 segundo//65536-(16MHz/1024/1Hz) = 49911 = 0xC2F7
